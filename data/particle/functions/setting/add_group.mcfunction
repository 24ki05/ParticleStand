...
execute if score ps CurrentGroup matches 1 unless score ps CurrentGroups matches 11 run data modify storage ps list append value {Group:0,Name:"(Not Entered)",particle:[1,2]}
